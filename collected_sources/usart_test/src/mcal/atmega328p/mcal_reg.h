 ...
 */
  ...
  namespace mcal
  {
    namespace reg
    {
      ...
      // USART registers
      constexpr std::uint8_t udr0 = 0xA6U + sfr_offset;
      constexpr std::uint8_t ucsr0a = 0xA0U + sfr_offset;
      constexpr std::uint8_t ucsr0b = 0xA1U + sfr_offset;
      constexpr std::uint8_t ucsr0c = 0xA2U + sfr_offset;
      constexpr std::uint8_t ubrr0l = 0xA4U + sfr_offset;
      constexpr std::uint8_t ubrr0h = 0xA5U + sfr_offset;
      ...
      // Power Reduction 
      constexpr std::uint8_t prr = 0x44U;
