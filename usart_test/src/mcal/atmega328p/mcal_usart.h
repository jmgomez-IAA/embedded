...
template<typename send_iterator_type>
bool mcal::usart::usart_communication::send_n(send_iterator_type first, send_iterator_type last)
{
...
template<typename recv_iterator_type>
bool mcal::usart::usart_communication::recv_n(recv_iterator_type first, recv_iterator_type last)
{
